...
const apiKey = "75692dedb2a948d2b1e202c7e8c71879"
...
fetchData('Farmer related breaking news',5).then(add_breakingNews)
...
fetchData('Maharashtra farming',10).then(add_topNews)
...
fetchData('changing crop prices in india',10).then(add_sportsNews)
...
fetchData('indian agriculture businesses',10).then(add_businessNews)
...
fetchData('agriculture technology changes in india',10).then(add_techNews)